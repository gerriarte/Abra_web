          ...
          return (
            ...
            >
              <div className="flex flex-col items-end gap-1">
                <span
                  className={`text-[10px] font-bold uppercase tracking-[0.25em] transition-all duration-500 ${textColor} ${isActive
                ...
                {section.image && (
                  <div className={`overflow-hidden rounded-md transition-all duration-500 border border-white/10 ${isActive ? 'h-10 w-16 opacity-100' : 'h-0 w-12 opacity-0 group-hover:h-8 group-hover:opacity-50'}`}>
              ...
              <div
                className={`h-[1px] transition-all duration-500 ease-out ${isActive
                  ? `${lineColor} w-12`
