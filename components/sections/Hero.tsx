...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Background Aesthetic Layers - Aperture Style */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="spatial-grid opacity-[0.03]" />
        
        {/* Dark vignette for text readability against sky */}
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at 30% 50%, rgba(0,0,0,0.45) 0%, rgba(0,0,0,0.15) 60%, transparent 100%)' }} />
      ...
      {/* Decorative Spin - The Ghost of Aperture */}
      <div className="absolute -right-[15%] top-1/2 -translate-y-1/2 w-[70%] h-[70%] opacity-[0.01] pointer-events-none select-none">
        <svg viewBox="0 0 200 200" className="w-full h-full text-white animate-spin-slow">
           <circle cx="100" cy="100" r="90" fill="none" stroke="currentColor" strokeWidth="0.1" strokeDasharray="10 5" />
           <circle cx="100" cy="100" r="70" fill="none" stroke="currentColor" strokeWidth="0.05" />
           <path d="M100,10 L100,30 M100,170 L100,190 M10,100 L30,100 M170,100 L190,100" stroke="currentColor" strokeWidth="0.1" />
        </svg>
      </div>
      ...
      >
        <span className="text-[9px] uppercase tracking-[0.5em] text-text-muted rotate-90 mb-4">Apertura</span>
