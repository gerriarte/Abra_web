...
const cases: Case[] = [
  { id: 'monyte', title: 'Monyte', category: 'Branding & Dev Crypto', metric: '100% Unificado', image: '/monyte/Monyte Banner.png', size: 'large' },
  ...
  { id: 'pre-concretos', title: 'Pre Concretos', category: 'Growth & Branding', metric: '+120% Leads', image: '/cases/pre-concretos.png', size: 'medium' },
  { id: 'rac', title: 'RealArt Crypto', category: 'Blockchain & UX', metric: 'Tokenización', image: '/RAC/Mockup Website.png', size: 'small' },
  { id: 'duvyclass', title: 'DuvyClass', category: 'Growth Marketing', metric: '-40% CAC', image: '/cases/duvyclass.png', size: 'medium' },
  { id: 'invia', title: 'Invia 1912', category: 'E-commerce Industrial', metric: '1500+ SKUs', image: '/Invia/Hero - Tienda Invia.png', size: 'medium' },
  { id: 'praxis-school', title: 'Praxis School', category: 'EdTech & Growth', metric: '+200% Growth', image: '/cases/praxis-school.png', size: 'small' },
  { id: 'bestune', title: 'Bestune', category: 'Audiovisual & AI', metric: 'Launch Campaign', image: '/Bestune/Bestune-01.jpg', size: 'medium' },
  { id: 'different-coffee', title: 'Differente Coffee', category: 'Growth & Redesign', metric: '+15% Mensual', image: '/differente-coffee/Differente-mock.png', size: 'small' },
  { id: 'gea-beauty', title: 'Gea Beauty', category: 'Health & Branding', metric: 'Branding V2', image: '/cases/gea-beauty.png', size: 'small' },
    ...
    <section id="cases" className="py-40 relative overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 relative z-10 max-w-7xl">
        ...
        >
          ...
          {/* Bento Grid Layout - More Spacious */}
            ...
            {cases.map((c, index) => (
              <motion.div
                ...
                className={`group relative rounded-[2.5rem] overflow-hidden border border-white/5 bg-surface/30 backdrop-blur-sm transition-all duration-1000 ${
                  c.size === 'large' ? 'md:col-span-8 md:row-span-2' : 
                  c.size === 'medium' ? 'md:col-span-4 md:row-span-2' : 
                ...
                <div className="absolute inset-0 p-10 flex flex-col justify-between z-10">
                   <div className="flex justify-between items-start">
                      <div className="flex flex-col gap-2">
                        ...
                        <h3 className={`${c.size === 'large' ? 'text-3xl md:text-4xl' : 'text-xl'} font-light text-text-primary tracking-tight`}>
                          {c.title}
                        </h3>
                      </div>
                      {c.metric && (
                   ...
                   <div className="flex justify-between items-end opacity-0 group-hover:opacity-100 translate-y-6 group-hover:translate-y-0 transition-all duration-700 ease-out">
                      <p className="text-xs text-text-secondary max-w-[240px] font-light leading-relaxed">
                        Implementación del A:BRA Loop para escalar operaciones y maximizar retención.
                      </p>
                      <Link 
                        href={`/cases/${c.id}`}
